  ...
  return (
        ...
        <div className="flex overflow-x-scroll pb-10 scrollbar-hide">
            <div className="flex flex-nowrap lg:ml-40 md:ml-20 ml-10">
                ...
                <div className="inline-block px-6 mr-4">
                    <div className="relative max-w-md w-64 h-64 md:w-80 md:h-80 py-4 px-6 my-16 rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out object-contain">
    ...
    <section className='bg-white flex flex-col items-center py-16 '>
        ...
        <div className=''>
            ...
            {/* Carousel  */}
            <div className="carousel carousel-center max-w-md">
                {/* Slide 1  */}
                <div className="carousel-item max-w-md ">
                    <div id="slide1" className="max-w-md py-4 px-16 bg-gray-200 rounded-lg mt-20 mb-2">
                ...
                {/* Slide 2  */}
                <div className="carousel-item max-w-md ">
                    <div id="slide2" className="max-w-md py-4 px-16 bg-gray-200 rounded-lg mt-20 mb-2">
                        <div className="flex justify-center md:justify-end -mt-16">
                            <img className="w-20 h-20 object-cover rounded-full border-2 border-secondary-200" src="https://images.unsplash.com/photo-1499714608240-22fc6ad53fb2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80" alt='Icon'/>
                        </div>
                        <div>
                        ...
                        <div className="flex justify-end mt-4">
                            <a href="/" className="text-xl font-medium text-gray-900">Soft</a>
                        </div>
                ...
                {/* Slide 3  */}
                <div className="carousel-item max-w-md">
                    <div id="slide3" className="max-w-md py-4 px-16 bg-gray-200 rounded-lg mt-20 mb-2">
                        <div className="flex justify-center md:justify-end -mt-16">
                            <img className="w-20 h-20 object-cover rounded-full border-2 border-secondary-200" src="https://images.unsplash.com/photo-1499714608240-22fc6ad53fb2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80" alt='Icon'/>
                        </div>
                        <div>
                        ...
                        <div className="flex justify-end mt-4">
                            <a href="/" className="text-xl font-medium text-gray-900">CCA</a>
                        </div>
